...
function Navbar() {
  ...
  return (
    <header className={`sticky top-0 z-99 ${scrolled && 'header'}`}>
      <div className="header-wrapper container mx-auto  w-full h-12 py-10 flex items-center justify-between">
        <div className="title flex items-center z-30">
          <Image src={LogoConnexsoft} alt="" height={35} />
          <h1 className="cnnx text-white pl-2 font-bold text-[20px]">
            ConnexSoft
          </h1>
        </div>
        <div className="nav-menu">
          <ul className="nav-links flex flex-row gap-8 font-medium text-white">
            ...
            <li className="duration-200 hover:-translate-y-1">Jadwal Piket</li>
