  ...
  return (
    <div className="relative -z-50 -mt-24 h-[700px] w-full">
      ...
      <div className="jumbotron-text flex flex-col gap-2 justify-center items-center h-full px-6">
        <h1 className="z-10 text-white md:text-5xl sm:text-4xl text-3xl lg:text-5xl font-[Mona] text-center">
          Welcome to Connexsoft
        </h1>
        <p className="text-white md:w-1/2 w-full lg:w-1/2 text-center opacity-60">
